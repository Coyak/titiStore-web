  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-brand-darker">
      <div className="max-w-md w-full space-y-8 bg-brand-dark p-8 rounded-2xl shadow-2xl border border-gray-800 animate-slide-up">
        <div>
          <h2 className="mt-2 text-center text-3xl font-extrabold text-white">Crea tu cuenta</h2>
          <p className="mt-2 text-center text-sm text-gray-400">Únete para comenzar a comprar</p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <Link to="/login" className="text-sm text-brand-orange hover:text-brand-orange-hover transition-colors">
